...
var StringView = exports.class = function StringView (
    vInput, 
    sEncoding /* optional (default: UTF-8) */, 
    nOffset /* optional */, 
    nLength /* optional */) 
  {
  var fTAView, aWhole, aRaw, fPutOutptCode, fGetOutptChrSize, nInptLen, 
  nStartIdx = isFinite(nOffset) ? nOffset : 0, nTranscrType = 15;
...
StringView.base64ToBytes = function (sBase64, nBlockBytes) {
  ...
  var
    sB64Enc = sBase64.replace(/.*,/, '').replace(/[^A-Za-z0-9\+\/]/g, ""), nInLen = sB64Enc.length,
